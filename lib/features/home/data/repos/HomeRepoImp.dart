...
import 'package:graduation/features/data/Models/product_in_store/product_in_store.dart';
import 'package:graduation/features/data/Models/store_product_get_category/store_product_get_category.dart';
...
class HomeRepoImp implements HomeRepo {
  ...
  Future<Either<Failure,List<StoreProductGetCategory>>>TopCategories()async{
    ...
    try{
      var data =await apiservice.get(endPoint: 'http://ma7aliapigp.runasp.net/api/Store/GetCategoriesInStore/storeId');
  ...
  Future<Either<Failure,List<ProductInStore>>>BestDeals()async{
      try{
      var data =await apiservice.get(endPoint: 'http://ma7aliapigp.runasp.net/api/Store/GetProductsInStore/storeId');
