...
import 'package:graduation/features/home/data/Models/store_product/store_product.dart';
import 'package:graduation/features/home/data/Models/store_product_get_category/store_product_get_category.dart';

abstract class HomeRepo {
  Future<Either<Failure, List<CategoryModel>>> TopCategories();
  ...
  Future<Either<Failure, List<ProductModel>>> ProductInStor();
}
